...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = Fisc.INSTANCE.CLIENT_NAME + " 1.8.8";
        ...
        String s2 = "Made by NBS";
        this.drawString(this.fontRendererObj, s2, this.width - this.fontRendererObj.getStringWidth(s1) - 2, this.height - 20, -1);
