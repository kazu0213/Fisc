...
import Client.Fisc.event.events.misc.EventMiddleClick;
import Client.Fisc.event.events.update.EventTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	private void createDisplay() throws LWJGLException {
		...
		Display.setTitle(Fisc.INSTANCE.CLIENT_NAME + " 1.8.8");
