...
import Client.Fisc.event.events.move.EventMove;
import Client.Fisc.event.events.move.EventPostMotionUpdates;
import Client.Fisc.event.events.move.EventPreMotionUpdates;
import Client.Fisc.event.events.player.EventSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	public void sendChatMessage(String message) {
		if (!Fisc.INSTANCE.COMMAND_MANAGER.processCommand(message)) {
